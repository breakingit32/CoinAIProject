...
class detectionCircle:
    ...
    #def __init__(self, frame):
        #t = threading.Thread(target=self.mains(frame))
        #t.start()
class film:
    ...
    #def __init__(self, frame):
        #t = threading.Thread(target=self.Camera(frame))
        #t.start()
...
threading.Thread(target=film().Camera, args=(frame_queue,)).start()
while True:
    ignore, frame = cam.read()
